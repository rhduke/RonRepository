...
/*
 * (Update): Properly writes the last bars of music. Able to handle a large input.
 * 
 * - Ron
 * 
 */
...
public class TextToPDFv1_07 {
	
	/* CONSTANTS */
	
	static final String INPUT_FILENAME = "try.txt";	// Name of input file to search for
	static final String PDF_FILENAME = "output.pdf";	// Filename of the output PDF file
	...
	{		
		TextToPDFv1_07 saad = new TextToPDFv1_07();
